              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-300 mt-0.5">
                    Candidate: <strong className="text-white">{submittedReport.candidateName}</strong> • Halfway Score:{' '}
                    <strong
                    ...
                    >
                      {submittedReport.overallScore}%
                    </strong>{' '}
                    • Test Cases Passed:{' '}
                    <strong className="text-indigo-300 font-mono">
                      {submittedReport.codingReportData?.passedTestCases}/{submittedReport.codingReportData?.totalTestCases}
                    </strong>
