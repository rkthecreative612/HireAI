...
import { User, Mail, Play, Plus, Sparkles, CheckCircle2, ChevronRight, Layers, HelpCircle, ShieldCheck, Clock, Trash2, AlertTriangle, Camera, ShieldAlert } from 'lucide-react';
...
interface RoleSelectorProps {
  ...
  isProctorModeEnabled?: boolean;
  onToggleProctorMode?: (enabled: boolean) => void;
}
            ...
            <div className="p-3.5 rounded-xl bg-white/5 border border-white/10 space-y-2">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <label htmlFor="proctor-mode-toggle" className="text-xs font-bold text-white block cursor-pointer">
                      AI Proctor Mode
                    </label>
                    <span className="text-[10px] text-slate-400">
                      Local MediaPipe face & gaze integrity check
                    </span>
                  </div>
                </div>
                ...
                <label className="relative inline-flex items-center cursor-pointer select-none">
                  <input
                    id="proctor-mode-toggle"
                    type="checkbox"
                    checked={isProctorModeEnabled}
                    onChange={(e) => onToggleProctorMode?.(e.target.checked)}
