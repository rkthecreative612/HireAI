...
export const CodingRoundView: React.FC<CodingRoundViewProps> = ({
  ...
  const handleStartAssessment = () => {
    if (!inputCandidateName.trim()) {
      setNameError('Please enter candidate full name to begin the assessment.');
      return;
    }
    setNameError('');
            ...
            <div className="bg-[#0F0F12] border border-white/10 rounded-2xl p-6 sm:p-8 space-y-6 max-w-2xl mx-auto shadow-2xl">
              ...
              <div className="pt-2 text-center">
                <button
                  ...
                  className="px-8 py-3 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-sm font-bold shadow-xl shadow-indigo-600/30 transition-all flex items-center justify-center space-x-2 mx-auto"
                >
